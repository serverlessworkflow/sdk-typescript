 ...
 */
function retriesBuildingFn(data) {
    return function () {
        var validate = validators.get('Retries');
 ...
 */
export function retriesBuilder() {
    return builder(retriesBuildingFn);
}
//# sourceMappingURL=retries-builder.js.map