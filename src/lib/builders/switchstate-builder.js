 ...
 */
function switchstateBuildingFn(data) {
    return function () {
        var validate = validators.get('Switchstate');
 ...
 */
export function switchstateBuilder() {
    return builder(switchstateBuildingFn);
}
//# sourceMappingURL=switchstate-builder.js.map