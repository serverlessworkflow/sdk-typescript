 ...
 */
function subflowstateBuildingFn(data) {
    return function () {
        data.type = 'subflow';
        var validate = validators.get('Subflowstate');
...
export function subflowstateBuilder() {
    return builder(subflowstateBuildingFn);
}
//# sourceMappingURL=subflowstate-builder.js.map