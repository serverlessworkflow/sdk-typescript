 ...
 */
function eventconditionBuildingFn(data) {
    return function () {
        var validate = validators.get('Eventcondition');
...
export function eventconditionBuilder() {
    return builder(eventconditionBuildingFn);
}
//# sourceMappingURL=eventcondition-builder.js.map