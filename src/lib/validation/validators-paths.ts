...
export const validatorsPaths: [string, string][] = [
  ...
  ['Transitioneventcondition', 'https://serverlessworkflow.io/schemas/0.6/workflow.json#/definitions/transitioneventcondition'],
  ...
  ['Transitiondatacondition', 'https://serverlessworkflow.io/schemas/0.6/workflow.json#/definitions/transitiondatacondition'],
