...
export const validationPointers = {
  ...
  CallAsyncAPIWith:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/0/properties/with',
  CallAsyncAPIWithAuthentication:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/0/properties/with/properties/authentication',
  CallFunction: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/4',
  CallFunctionWith:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/4/properties/with',
  CallGRPC: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/1',
  CallGRPCWith:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/1/properties/with',
  CallGRPCWithArguments:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/1/properties/with/properties/arguments',
  CallGRPCWithService:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/1/properties/with/properties/service',
  CallGRPCWithServiceAuthentication:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/1/properties/with/properties/service/properties/authentication',
  CallHTTP: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/2',
  CallHTTPWith:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/2/properties/with',
  CallHTTPWithEndpoint:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/2/properties/with/properties/endpoint',
  CallOpenAPI: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/3',
  CallOpenAPIWith:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/3/properties/with',
  CallOpenAPIWithAuthentication:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/3/properties/with/properties/authentication',
  CallOpenAPIWithParameters:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/callTask/oneOf/3/properties/with/properties/parameters',
  ...
  EmitTaskEmit: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/emitTask/properties/emit',
  EmitTaskEmitEvent:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/emitTask/properties/emit/properties/event',
  ...
  ForkTaskFork: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/forkTask/properties/fork',
  ForTask: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/forTask',
  ForTaskFor: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/forTask/properties/for',
  Input: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/input',
  ListenTask: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/listenTask',
  ListenTaskListen:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/listenTask/properties/listen',
  Oauth2Token: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/oauth2Token',
  Output: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/output',
  RaiseTask: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/raiseTask',
  RaiseTaskRaise: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/raiseTask/properties/raise',
  ...
  RunTaskRun: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run',
  RunTaskRunContainer:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/0/properties/container',
  RunTaskRunScript:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/1/properties/script',
  RunTaskRunShell:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/2/properties/shell',
  RunTaskRunShellArguments:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/2/properties/shell/properties/arguments',
  RunTaskRunShellEnvironment:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/2/properties/shell/properties/environment',
  RunTaskRunWorkflow:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/3/properties/workflow',
  RunTaskRunWorkflowInput:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/runTask/properties/run/oneOf/3/properties/workflow/properties/input',
  ...
  SetTaskSet: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/setTask/properties/set',
  ...
  Timeout: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/timeout',
  TryTask: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/tryTask',
  TryTaskCatch: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/$defs/tryTask/properties/catch',
  Use: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use',
  UseAuthentications:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use/properties/authentications',
  UseErrors: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use/properties/errors',
  UseExtensions:
    'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use/properties/extensions',
  UseFunctions: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use/properties/functions',
  UseRetries: 'https://serverlessworkflow.io/schemas/1.0.0-alpha2/workflow.json#/properties/use/properties/retries',
