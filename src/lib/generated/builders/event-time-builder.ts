 ...
 * @returns {Builder<Specification.EventTime>} A builder for `Specification.EventTime`
 */
export const eventTimeBuilder = (model?: Partial<Specification.EventTime>): Builder<Specification.EventTime> =>
  builder<Specification.EventTime>(model, buildingFn);
