...
export const validatorsPaths: [string, string][] = [
  ...
  [
    ...
    'https://serverlessworkflow.io/schemas/0.7/workflow.json#/definitions/eventbasedswitchstate',
  ],
  ['Databasedswitchstate', 'https://serverlessworkflow.io/schemas/0.7/workflow.json#/definitions/databasedswitchstate'],
